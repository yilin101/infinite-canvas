                        ...
                        children: (
                            <Form layout="vertical" requiredMark={false}>
                                <section className="rounded-lg border border-stone-200 p-3 dark:border-stone-800">
                                    <div className="text-sm font-semibold">图床配置</div>
                                    <div className="mt-1 text-xs leading-5 text-stone-500">图片节点的“传图床”会通过服务端代理上传。只填写根域名，上传成功后会返回 HTTPS 链接。</div>
                                    <Form.Item label="图床根域名" extra="只填 brp2o0stwv.xin。上传成功后会自动生成 https://brp2o0stwv.xin，并替换返回链接的域名。" className="mb-0 mt-4">
