...
import { uploadImageToHost } from "@/services/api/image-host";
...
import { CanvasSketchReferenceDialog } from "@/components/canvas/canvas-sketch-reference-dialog";
...
import { buildCanvasResourceReferences, buildNodeMentionReferences } from "@/lib/canvas/canvas-resource-references";import {
    CanvasNodeType,
...
function InfiniteCanvasPage() {
    ...
    const uploadNodeImageToHost = useCallback(
        ...
        <main className="flex h-full min-h-0 overflow-hidden" style={{ background: theme.canvas.background, color: theme.node.text }}>
            <section className="relative min-w-0 flex-1 overflow-hidden">
                ...
                <CanvasNodeHoverToolbar
                    ...
                    onUploadImageHost={(node) => void uploadNodeImageToHost(node)}
                    onRetry={(node) => void handleRetryNode(node)}
