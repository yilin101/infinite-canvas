...
import { Brush, Camera, CloudUpload, Copy, FileText, Grid2x2, Lock, LockOpen, Maximize2, Scissors, Sparkles, Upload, ZoomIn } from "lucide-react";

import type { CanvasNodeData } from "../types";

export type ImageNodeActionToolId = "copyPrompt" | "reversePrompt" | "uploadImageHost" | "replace" | "resize" | "maskEdit" | "crop" | "split" | "upscale" | "superResolve" | "angle" | "view";
...
export type ImageToolHandlers = {
    ...
    onUploadImageHost: (node: CanvasNodeData) => void;
};
...
export const imageToolDefinitions: ImageToolDefinition[] = [
    ...
    },
    {
        ...
        run: (node, handlers) => handlers.onUploadImageHost(node),
    },
    {
        id: "replace",
        defaultVisible: true,
